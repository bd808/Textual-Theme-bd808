...
(function() {
  ...
  MUTED = ['ecmabot-wm', 'gh-datavalues', 'gh-wmde', 'github', 'github-wmde', 'grrrit-wm', 'grrrit-wm1', 'grrrit-wm2', 'icinga-wm', 'labs-morebots', 'libel', 'morebots', 'mostbots', 'mw-jenkinsbot', 'phabot', 'phawikibugs', 'phawkes', 'pywikibugs', 'pywikibugs2', 'qa-morebots', 'services_bot', 'shinken-wm', 'snitch', 'travis-ci', 'wikibugs', 'wikibugs2', 'wikiphabot', 'wm-bot', 'wm-bot3', 'wm-labs-meetbot', 'wm-labs-meetbot`', 'wmf-insecte', 'wmf-selenium-bot'];
