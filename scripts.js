...
(function() {
  ...
  MUTED = ['grrrit-wm', 'icinga-wm', 'labs-morebots', 'libel', 'morebots', 'mw-jenkinsbot', 'snitch', 'wikibugs', 'wm-bot', 'wm-bot3', 'wm-labs-meetbot', 'wm-labs-meetbot`', 'wmf-insecte', 'wmf-selenium-bot'];
