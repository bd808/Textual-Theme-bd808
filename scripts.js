...
(function() {
  ...
  MUTED = ['ecmabot-wm', 'grrrit-wm', 'grrrit-wm1', 'grrrit-wm2', 'icinga-wm', 'labs-morebots', 'libel', 'morebots', 'mostbots', 'mw-jenkinsbot', 'pywikibugs', 'pywikibugs2', 'snitch', 'wikibugs', 'wikiphabot', 'wm-bot', 'wm-bot3', 'wm-labs-meetbot', 'wm-labs-meetbot`', 'wmf-insecte', 'wmf-selenium-bot'];
