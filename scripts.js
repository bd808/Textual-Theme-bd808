...
(function() {
  ...
  MUTED = ['analytics-logbot', 'antispammeta', 'arseny92', 'cerebrumbot', 'cp', 'cyberpower678', 'danny_b', 'ecmabot-wm', 'eir', 'gh-datavalues', 'gh-wmde', 'github', 'github-wmde', 'grrrit-wm', 'icinga-wm', 'ircnotifier', 'justberry', 'krrrit-wm', 'labs-morebots', 'libel', 'morebots', 'mostbots', 'mw-jenkinsbot', 'paladox', 'phabot', 'phawikibugs', 'phawkes', 'pywikibugs', 'qa-morebots', 'services_bot', 'shinken-wm', 'slander', 'snitch', 'stashbot', 'travis-ci', 'wikibugs', 'wikipedia-github', 'wikiphabot', 'wm-bot', 'wm-labs-meetbot', 'wmf-insecte', 'wmf-selenium-bot', 'zppix'];
