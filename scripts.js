...
(function() {
  ...
  MUTED = ['analytics-logbot', 'antispammeta', 'arseny', 'asimovbot', 'cerebrumbot', 'cp', 'cyberpower', 'danny_b', 'ecmabot-wm', 'eir', 'gh-datavalues', 'gh-wmde', 'github', 'github-wmde', 'grrrit-wm', 'guest', 'icinga-wm', 'ircnotifier', 'jinxer-wm', 'jinxer-wm-test', 'justberry', 'krrrit-wm', 'labs-morebots', 'libel', 'librenms-wmf', 'mw-jenkinsbot', 'nokib', 'opendevreview', 'paladox', 'phabot', 'phawikibugs', 'phawkes', 'pywikibugs', 'services_bot', 'shinken-wm', 'sirenbot', 'slander', 'snitch', 'stashbot', 'stewardbot', 'travis-ci', 'wikibugs', 'wikimediagithub', 'wikipedia-github', 'wikiphabot', 'wm-bot', 'wm-labs-meetbot', 'wmf-insecte', 'wmf-selenium-bot', 'wmopbot', 'zppix'];
