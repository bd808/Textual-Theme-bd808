...
(function() {
  ...
  MUTED = ['ecmabot-wm', 'gh-datavalues', 'gh-wmde', 'github', 'github-wmde', 'grrrit-wm', 'grrrit-wm1', 'grrrit-wm2', 'icinga-wm', 'ircnotifier', 'krrrit-wm', 'krrrit-wm1', 'labs-morebots', 'libel', 'morebots', 'mostbots', 'mw-jenkinsbot', 'phabot', 'phawikibugs', 'phawkes', 'pywikibugs', 'pywikibugs2', 'qa-morebots', 'services_bot', 'services_bot1', 'shinken-wm', 'snitch', 'travis-ci', 'wikibugs', 'wikibugs2', 'wikipedia-github', 'wikiphabot', 'wm-bot', 'wm-bot3', 'wm-labs-meetbot', 'wm-labs-meetbot`', 'wmf-insecte', 'wmf-selenium-bot'];
