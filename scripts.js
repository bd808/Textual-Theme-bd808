...
(function() {
  ...
  MUTED = ['analytics-logbot', 'antispammeta', 'arseny', 'AsimovBot', 'cerebrumbot', 'cp', 'cyberpower', 'danny_b', 'ecmabot-wm', 'eir', 'gh-datavalues', 'gh-wmde', 'github', 'github-wmde', 'grrrit-wm', 'guest', 'icinga-wm', 'ircnotifier', 'jinxer-wm', 'justberry', 'krrrit-wm', 'labs-morebots', 'libel', 'librenms-wmf', 'mw-jenkinsbot', 'nokib', 'paladox', 'phabot', 'phawikibugs', 'phawkes', 'pywikibugs', 'services_bot', 'shinken-wm', 'slander', 'snitch', 'stashbot', 'travis-ci', 'wikibugs', 'wikipedia-github', 'wikiphabot', 'wm-bot', 'wm-labs-meetbot', 'wmf-insecte', 'wmf-selenium-bot', 'zppix'];
